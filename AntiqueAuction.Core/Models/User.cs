...
namespace AntiqueAuction.Core.Models
{
    public class User:AggregateRoot
    {
        ...
        private readonly MultiObjectLocker<Guid> _drawMoneyLocker = new MultiObjectLocker<Guid>();
        protected User(){}
        ...
        public void UpdateMaxBid(double amount)
        {
            if (amount > WalletAmount)
                throw new UnprocessableException("Cannot update Max Bid Amount greater than Wallet Amount");
            MaxBidAmount = amount;
        }
